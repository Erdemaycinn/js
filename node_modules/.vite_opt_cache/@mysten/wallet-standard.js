...
const WALLET_STANDARD_ERROR__FEATURES__WALLET_FEATURE_UNIMPLEMENTED = 6160002;
...
var suins = createCommonjsModule(function (module) {
...
var moveRegistry = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const isValidNamedPackage = (name) => {
  ...
  if (!(0, suins.isValidSuiNSName)(org)) return false;
...
var suiTypes = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function isValidTransactionDigest(value) {
  try {
    const buffer = (0, esm.fromBase58)(value);
...
function parseStructTag(type) {
  ...
  const isMvrPackage = (0, moveRegistry.isValidNamedPackage)(address);
  const rest = type.slice(address.length + module2.length + 4);
  const name = rest.includes("<") ? rest.slice(0, rest.indexOf("<")) : rest;
  const typeParams = rest.includes("<") ? (0, esm.splitGenericParameters)(rest.slice(rest.indexOf("<") + 1, rest.lastIndexOf(">"))).map(
...
var typeTagSerializer = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
class TypeTagSerializer {
  static parseFromStr(str, normalizeAddress = false) {
    ...
    if (structMatch) {
      const address = normalizeAddress ? (0, suiTypes.normalizeSuiAddress)(structMatch[1]) : structMatch[1];
      return {
        struct: {
          address,
  ...
  static parseStructTypeArgs(str, normalizeAddress = false) {
    return (0, esm.splitGenericParameters)(str).map(
...
var bcs$1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function optionEnum(type) {
  return esm.bcs.enum("Option", {
    None: null,
    Some: type
  });
}
const Address = esm.bcs.bytes(suiTypes.SUI_ADDRESS_LENGTH).transform({
  validate: (val) => {
    const address = typeof val === "string" ? val : (0, esm.toHex)(val);
    if (!address || !(0, suiTypes.isValidSuiAddress)((0, suiTypes.normalizeSuiAddress)(address))) {
      throw new Error(`Invalid Sui address ${address}`);
    }
  },
  input: (val) => typeof val === "string" ? (0, esm.fromHex)((0, suiTypes.normalizeSuiAddress)(val)) : val,
  output: (val) => (0, suiTypes.normalizeSuiAddress)((0, esm.toHex)(val))
});
const ObjectDigest = esm.bcs.vector(esm.bcs.u8()).transform({
  name: "ObjectDigest",
  input: (value) => (0, esm.fromBase58)(value),
  output: (value) => (0, esm.toBase58)(new Uint8Array(value)),
  validate: (value) => {
    if ((0, esm.fromBase58)(value).length !== 32) {
      throw new Error("ObjectDigest must be 32 bytes");
    }
  }
});
const SuiObjectRef = esm.bcs.struct("SuiObjectRef", {
  objectId: Address,
  version: esm.bcs.u64(),
  digest: ObjectDigest
});
const SharedObjectRef = esm.bcs.struct("SharedObjectRef", {
  objectId: Address,
  initialSharedVersion: esm.bcs.u64(),
  mutable: esm.bcs.bool()
});
const ObjectArg = esm.bcs.enum("ObjectArg", {
  ImmOrOwnedObject: SuiObjectRef,
  SharedObject: SharedObjectRef,
  Receiving: SuiObjectRef
});
const Owner = esm.bcs.enum("Owner", {
  AddressOwner: Address,
  ObjectOwner: Address,
  Shared: esm.bcs.struct("Shared", {
    initialSharedVersion: esm.bcs.u64()
  }),
  Immutable: null,
  ConsensusV2: esm.bcs.struct("ConsensusV2", {
    authenticator: esm.bcs.enum("Authenticator", {
      SingleOwner: Address
    }),
    startVersion: esm.bcs.u64()
  })
});
const CallArg = esm.bcs.enum("CallArg", {
  Pure: esm.bcs.struct("Pure", {
    bytes: esm.bcs.vector(esm.bcs.u8()).transform({
      input: (val) => typeof val === "string" ? (0, esm.fromBase64)(val) : val,
      output: (val) => (0, esm.toBase64)(new Uint8Array(val))
    })
  }),
  Object: ObjectArg
});
const InnerTypeTag = esm.bcs.enum("TypeTag", {
  bool: null,
  u8: null,
  u64: null,
  u128: null,
  address: null,
  signer: null,
  vector: esm.bcs.lazy(() => InnerTypeTag),
  struct: esm.bcs.lazy(() => StructTag),
  u16: null,
  u32: null,
  u256: null
});
const TypeTag = InnerTypeTag.transform({
  input: (typeTag) => typeof typeTag === "string" ? typeTagSerializer.TypeTagSerializer.parseFromStr(typeTag, true) : typeTag,
  output: (typeTag) => typeTagSerializer.TypeTagSerializer.tagToString(typeTag)
});
const Argument = esm.bcs.enum("Argument", {
  GasCoin: null,
  Input: esm.bcs.u16(),
  Result: esm.bcs.u16(),
  NestedResult: esm.bcs.tuple([esm.bcs.u16(), esm.bcs.u16()])
});
const ProgrammableMoveCall = esm.bcs.struct("ProgrammableMoveCall", {
  package: Address,
  module: esm.bcs.string(),
  function: esm.bcs.string(),
  typeArguments: esm.bcs.vector(TypeTag),
  arguments: esm.bcs.vector(Argument)
});
const Command = esm.bcs.enum("Command", {
  /**
   ...
   */
  TransferObjects: esm.bcs.struct("TransferObjects", {
    objects: esm.bcs.vector(Argument),
    address: Argument
  }),
  // /**
  //  * Split `amount` from a `coin`.
  //  */
  SplitCoins: esm.bcs.struct("SplitCoins", {
    coin: Argument,
    amounts: esm.bcs.vector(Argument)
  }),
  // /**
  //  * Merge Vector of Coins (`sources`) into a `destination`.
  //  */
  MergeCoins: esm.bcs.struct("MergeCoins", {
    destination: Argument,
    sources: esm.bcs.vector(Argument)
  }),
  // /**
  //  * Publish a Move module.
  //  */
  Publish: esm.bcs.struct("Publish", {
    modules: esm.bcs.vector(
      esm.bcs.vector(esm.bcs.u8()).transform({
        input: (val) => typeof val === "string" ? (0, esm.fromBase64)(val) : val,
        output: (val) => (0, esm.toBase64)(new Uint8Array(val))
      })
    ),
    dependencies: esm.bcs.vector(Address)
  }),
  // /**
  ...
  //  */
  MakeMoveVec: esm.bcs.struct("MakeMoveVec", {
    ...
    elements: esm.bcs.vector(Argument)
  }),
  Upgrade: esm.bcs.struct("Upgrade", {
    modules: esm.bcs.vector(
      esm.bcs.vector(esm.bcs.u8()).transform({
        input: (val) => typeof val === "string" ? (0, esm.fromBase64)(val) : val,
        output: (val) => (0, esm.toBase64)(new Uint8Array(val))
...
const ProgrammableTransaction = esm.bcs.struct("ProgrammableTransaction", {
  inputs: esm.bcs.vector(CallArg),
  commands: esm.bcs.vector(Command)
});
const TransactionKind = esm.bcs.enum("TransactionKind", {
  ProgrammableTransaction,
  ChangeEpoch: null,
  Genesis: null,
  ConsensusCommitPrologue: null
});
const TransactionExpiration = esm.bcs.enum("TransactionExpiration", {
  None: null,
  Epoch: unsafe_u64()
});
const StructTag = esm.bcs.struct("StructTag", {
  address: Address,
  module: esm.bcs.string(),
  name: esm.bcs.string(),
  typeParams: esm.bcs.vector(InnerTypeTag)
});
const GasData = esm.bcs.struct("GasData", {
  payment: esm.bcs.vector(SuiObjectRef),
  owner: Address,
  price: esm.bcs.u64(),
  budget: esm.bcs.u64()
});
const TransactionDataV1 = esm.bcs.struct("TransactionDataV1", {
  kind: TransactionKind,
  sender: Address,
  gasData: GasData,
  expiration: TransactionExpiration
});
const TransactionData = esm.bcs.enum("TransactionData", {
  V1: TransactionDataV1
});
const IntentScope = esm.bcs.enum("IntentScope", {
  TransactionData: null,
  TransactionEffects: null,
  CheckpointSummary: null,
  PersonalMessage: null
});
const IntentVersion = esm.bcs.enum("IntentVersion", {
  V0: null
});
const AppId = esm.bcs.enum("AppId", {
  Sui: null
});
const Intent = esm.bcs.struct("Intent", {
  scope: IntentScope,
  version: IntentVersion,
  appId: AppId
});
function IntentMessage(T) {
  return esm.bcs.struct(`IntentMessage<${T.name}>`, {
    intent: Intent,
    value: T
  });
}
const CompressedSignature = esm.bcs.enum("CompressedSignature", {
  ED25519: esm.bcs.fixedArray(64, esm.bcs.u8()),
  Secp256k1: esm.bcs.fixedArray(64, esm.bcs.u8()),
  Secp256r1: esm.bcs.fixedArray(64, esm.bcs.u8()),
  ZkLogin: esm.bcs.vector(esm.bcs.u8())
});
const PublicKey = esm.bcs.enum("PublicKey", {
  ED25519: esm.bcs.fixedArray(32, esm.bcs.u8()),
  Secp256k1: esm.bcs.fixedArray(33, esm.bcs.u8()),
  Secp256r1: esm.bcs.fixedArray(33, esm.bcs.u8()),
  ZkLogin: esm.bcs.vector(esm.bcs.u8())
});
const MultiSigPkMap = esm.bcs.struct("MultiSigPkMap", {
  pubKey: PublicKey,
  weight: esm.bcs.u8()
});
const MultiSigPublicKey = esm.bcs.struct("MultiSigPublicKey", {
  pk_map: esm.bcs.vector(MultiSigPkMap),
  threshold: esm.bcs.u16()
});
const MultiSig = esm.bcs.struct("MultiSig", {
  sigs: esm.bcs.vector(CompressedSignature),
  bitmap: esm.bcs.u16(),
  multisig_pk: MultiSigPublicKey
});
const base64String = esm.bcs.vector(esm.bcs.u8()).transform({
  input: (val) => typeof val === "string" ? (0, esm.fromBase64)(val) : val,
  output: (val) => (0, esm.toBase64)(new Uint8Array(val))
});
const SenderSignedTransaction = esm.bcs.struct("SenderSignedTransaction", {
  intentMessage: IntentMessage(TransactionData),
  txSignatures: esm.bcs.vector(base64String)
});
const SenderSignedData = esm.bcs.vector(SenderSignedTransaction, {
  name: "SenderSignedData"
});
const PasskeyAuthenticator = esm.bcs.struct("PasskeyAuthenticator", {
  authenticatorData: esm.bcs.vector(esm.bcs.u8()),
  clientDataJson: esm.bcs.string(),
  userSignature: esm.bcs.vector(esm.bcs.u8())
});

});

var effects = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const PackageUpgradeError = esm.bcs.enum("PackageUpgradeError", {
  UnableToFetchPackage: esm.bcs.struct("UnableToFetchPackage", { packageId: bcs$1.Address }),
  NotAPackage: esm.bcs.struct("NotAPackage", { objectId: bcs$1.Address }),
  IncompatibleUpgrade: null,
  DigestDoesNotMatch: esm.bcs.struct("DigestDoesNotMatch", { digest: esm.bcs.vector(esm.bcs.u8()) }),
  UnknownUpgradePolicy: esm.bcs.struct("UnknownUpgradePolicy", { policy: esm.bcs.u8() }),
  PackageIDDoesNotMatch: esm.bcs.struct("PackageIDDoesNotMatch", {
    packageId: bcs$1.Address,
    ticketId: bcs$1.Address
  })
});
const ModuleId = esm.bcs.struct("ModuleId", {
  address: bcs$1.Address,
  name: esm.bcs.string()
});
const MoveLocation = esm.bcs.struct("MoveLocation", {
  module: ModuleId,
  function: esm.bcs.u16(),
  instruction: esm.bcs.u16(),
  functionName: esm.bcs.option(esm.bcs.string())
});
const CommandArgumentError = esm.bcs.enum("CommandArgumentError", {
  TypeMismatch: null,
  InvalidBCSBytes: null,
  InvalidUsageOfPureArg: null,
  InvalidArgumentToPrivateEntryFunction: null,
  IndexOutOfBounds: esm.bcs.struct("IndexOutOfBounds", { idx: esm.bcs.u16() }),
  SecondaryIndexOutOfBounds: esm.bcs.struct("SecondaryIndexOutOfBounds", {
    resultIdx: esm.bcs.u16(),
    secondaryIdx: esm.bcs.u16()
  }),
  InvalidResultArity: esm.bcs.struct("InvalidResultArity", { resultIdx: esm.bcs.u16() }),
...
const TypeArgumentError = esm.bcs.enum("TypeArgumentError", {
  TypeNotFound: null,
  ConstraintNotSatisfied: null
});
const ExecutionFailureStatus = esm.bcs.enum("ExecutionFailureStatus", {
  InsufficientGas: null,
  InvalidGasObject: null,
  InvariantViolation: null,
  FeatureNotYetSupported: null,
  MoveObjectTooBig: esm.bcs.struct("MoveObjectTooBig", {
    objectSize: esm.bcs.u64(),
    maxObjectSize: esm.bcs.u64()
  }),
  MovePackageTooBig: esm.bcs.struct("MovePackageTooBig", {
    objectSize: esm.bcs.u64(),
    maxObjectSize: esm.bcs.u64()
  }),
  CircularObjectOwnership: esm.bcs.struct("CircularObjectOwnership", { object: bcs$1.Address }),
  InsufficientCoinBalance: null,
  CoinBalanceOverflow: null,
  PublishErrorNonZeroAddress: null,
  SuiMoveVerificationError: null,
  MovePrimitiveRuntimeError: esm.bcs.option(MoveLocation),
  MoveAbort: esm.bcs.tuple([MoveLocation, esm.bcs.u64()]),
  ...
  CommandArgumentError: esm.bcs.struct("CommandArgumentError", {
    argIdx: esm.bcs.u16(),
    kind: CommandArgumentError
  }),
  TypeArgumentError: esm.bcs.struct("TypeArgumentError", {
    argumentIdx: esm.bcs.u16(),
    kind: TypeArgumentError
  }),
  UnusedValueWithoutDrop: esm.bcs.struct("UnusedValueWithoutDrop", {
    resultIdx: esm.bcs.u16(),
    secondaryIdx: esm.bcs.u16()
  }),
  InvalidPublicFunctionReturnType: esm.bcs.struct("InvalidPublicFunctionReturnType", {
    idx: esm.bcs.u16()
  }),
  InvalidTransferObject: null,
  EffectsTooLarge: esm.bcs.struct("EffectsTooLarge", { currentSize: esm.bcs.u64(), maxSize: esm.bcs.u64() }),
  PublishUpgradeMissingDependency: null,
  PublishUpgradeDependencyDowngrade: null,
  PackageUpgradeError: esm.bcs.struct("PackageUpgradeError", { upgradeError: PackageUpgradeError }),
  WrittenObjectsTooLarge: esm.bcs.struct("WrittenObjectsTooLarge", {
    currentSize: esm.bcs.u64(),
    maxSize: esm.bcs.u64()
  }),
  ...
  ExecutionCancelledDueToSharedObjectCongestion: esm.bcs.struct(
    "ExecutionCancelledDueToSharedObjectCongestion",
    {
      congestedObjects: esm.bcs.vector(bcs$1.Address)
    }
  ),
  AddressDeniedForCoin: esm.bcs.struct("AddressDeniedForCoin", {
    address: bcs$1.Address,
    coinType: esm.bcs.string()
  }),
  CoinTypeGlobalPause: esm.bcs.struct("CoinTypeGlobalPause", { coinType: esm.bcs.string() }),
  ExecutionCancelledDueToRandomnessUnavailable: null
});
const ExecutionStatus = esm.bcs.enum("ExecutionStatus", {
  Success: null,
  Failed: esm.bcs.struct("ExecutionFailed", {
    error: ExecutionFailureStatus,
    command: esm.bcs.option(esm.bcs.u64())
  })
});
const GasCostSummary = esm.bcs.struct("GasCostSummary", {
  computationCost: esm.bcs.u64(),
  storageCost: esm.bcs.u64(),
  storageRebate: esm.bcs.u64(),
  nonRefundableStorageFee: esm.bcs.u64()
});
const TransactionEffectsV1 = esm.bcs.struct("TransactionEffectsV1", {
  status: ExecutionStatus,
  executedEpoch: esm.bcs.u64(),
  gasUsed: GasCostSummary,
  modifiedAtVersions: esm.bcs.vector(esm.bcs.tuple([bcs$1.Address, esm.bcs.u64()])),
  sharedObjects: esm.bcs.vector(bcs$1.SuiObjectRef),
  transactionDigest: bcs$1.ObjectDigest,
  created: esm.bcs.vector(esm.bcs.tuple([bcs$1.SuiObjectRef, bcs$1.Owner])),
  mutated: esm.bcs.vector(esm.bcs.tuple([bcs$1.SuiObjectRef, bcs$1.Owner])),
  unwrapped: esm.bcs.vector(esm.bcs.tuple([bcs$1.SuiObjectRef, bcs$1.Owner])),
  deleted: esm.bcs.vector(bcs$1.SuiObjectRef),
  unwrappedThenDeleted: esm.bcs.vector(bcs$1.SuiObjectRef),
  wrapped: esm.bcs.vector(bcs$1.SuiObjectRef),
  gasObject: esm.bcs.tuple([bcs$1.SuiObjectRef, bcs$1.Owner]),
  eventsDigest: esm.bcs.option(bcs$1.ObjectDigest),
  dependencies: esm.bcs.vector(bcs$1.ObjectDigest)
});
const VersionDigest = esm.bcs.tuple([esm.bcs.u64(), bcs$1.ObjectDigest]);
const ObjectIn = esm.bcs.enum("ObjectIn", {
  NotExist: null,
  Exist: esm.bcs.tuple([VersionDigest, bcs$1.Owner])
});
const ObjectOut = esm.bcs.enum("ObjectOut", {
  NotExist: null,
  ObjectWrite: esm.bcs.tuple([bcs$1.ObjectDigest, bcs$1.Owner]),
  PackageWrite: VersionDigest
});
const IDOperation = esm.bcs.enum("IDOperation", {
  None: null,
  Created: null,
  Deleted: null
});
const EffectsObjectChange = esm.bcs.struct("EffectsObjectChange", {
  inputState: ObjectIn,
  outputState: ObjectOut,
  idOperation: IDOperation
});
const UnchangedSharedKind = esm.bcs.enum("UnchangedSharedKind", {
  ReadOnlyRoot: VersionDigest,
  MutateDeleted: esm.bcs.u64(),
  ReadDeleted: esm.bcs.u64(),
  Cancelled: esm.bcs.u64(),
  PerEpochConfig: null
});
const TransactionEffectsV2 = esm.bcs.struct("TransactionEffectsV2", {
  status: ExecutionStatus,
  executedEpoch: esm.bcs.u64(),
  gasUsed: GasCostSummary,
  transactionDigest: bcs$1.ObjectDigest,
  gasObjectIndex: esm.bcs.option(esm.bcs.u32()),
  eventsDigest: esm.bcs.option(bcs$1.ObjectDigest),
  dependencies: esm.bcs.vector(bcs$1.ObjectDigest),
  lamportVersion: esm.bcs.u64(),
  changedObjects: esm.bcs.vector(esm.bcs.tuple([bcs$1.Address, EffectsObjectChange])),
  unchangedSharedObjects: esm.bcs.vector(esm.bcs.tuple([bcs$1.Address, UnchangedSharedKind])),
  auxDataDigest: esm.bcs.option(bcs$1.ObjectDigest)
});
const TransactionEffects = esm.bcs.enum("TransactionEffects", {
...
var pure = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function pureBcsSchemaFromTypeName(name) {
  switch (name) {
    ...
    case "bool":
      return esm.bcs.bool();
    case "string":
      return esm.bcs.string();
    case "id":
    case "address":
      return bcs$1.Address;
  }
  const generic = name.match(/^(vector|option)<(.+)>$/);
  if (generic) {
    const [kind, inner] = generic.slice(1);
    if (kind === "vector") {
      return esm.bcs.vector(pureBcsSchemaFromTypeName(inner));
    } else {
      return esm.bcs.option(pureBcsSchemaFromTypeName(inner));
    }
  }
...
var bcs$2 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
__export(bcs_exports, {
  ...
  TypeTagSerializer: () => typeTagSerializer.TypeTagSerializer,
  bcs: () => suiBcs,
  pureBcsSchemaFromTypeName: () => pure.pureBcsSchemaFromTypeName
});
module.exports = __toCommonJS(bcs_exports);
...
const suiBcs = {
  ...
  U128: esm.bcs.u128(),
  U256: esm.bcs.u256(),
  ULEB128: esm.bcs.uleb128(),
  Bool: esm.bcs.bool(),
  String: esm.bcs.string(),
  Address: bcs$1.Address,
  AppId: bcs$1.AppId,
  Argument: bcs$1.Argument,
  CallArg: bcs$1.CallArg,
  Command: bcs$1.Command,
  CompressedSignature: bcs$1.CompressedSignature,
  GasData: bcs$1.GasData,
  Intent: bcs$1.Intent,
  IntentMessage: bcs$1.IntentMessage,
  IntentScope: bcs$1.IntentScope,
  IntentVersion: bcs$1.IntentVersion,
  MultiSig: bcs$1.MultiSig,
  MultiSigPkMap: bcs$1.MultiSigPkMap,
  MultiSigPublicKey: bcs$1.MultiSigPublicKey,
  ObjectArg: bcs$1.ObjectArg,
  ObjectDigest: bcs$1.ObjectDigest,
  Owner: bcs$1.Owner,
  PasskeyAuthenticator: bcs$1.PasskeyAuthenticator,
  ProgrammableMoveCall: bcs$1.ProgrammableMoveCall,
  ProgrammableTransaction: bcs$1.ProgrammableTransaction,
  PublicKey: bcs$1.PublicKey,
  SenderSignedData: bcs$1.SenderSignedData,
  SenderSignedTransaction: bcs$1.SenderSignedTransaction,
  SharedObjectRef: bcs$1.SharedObjectRef,
  StructTag: bcs$1.StructTag,
  SuiObjectRef: bcs$1.SuiObjectRef,
  TransactionData: bcs$1.TransactionData,
  TransactionDataV1: bcs$1.TransactionDataV1,
  TransactionEffects: effects.TransactionEffects,
  TransactionExpiration: bcs$1.TransactionExpiration,
  TransactionKind: bcs$1.TransactionKind,
  TypeTag: bcs$1.TypeTag
};

});

var index = /*@__PURE__*/unwrapExports(bcs$2);
...
const SUI_CLOCK_OBJECT_ID = (0, suiTypes.normalizeSuiObjectId)("0x6");
const SUI_SYSTEM_MODULE_NAME = "sui_system";
const SUI_TYPE_ARG = `${SUI_FRAMEWORK_ADDRESS}::sui::SUI`;
const SUI_SYSTEM_STATE_OBJECT_ID = (0, suiTypes.normalizeSuiObjectId)("0x5");
...
var _blake = createCommonjsModule(function (module, exports) {
Object.defineProperty(exports, "__esModule", { value: true });
...
function G1s(a, b, c, d, x) {
    a = (a + b + x) | 0;
    d = (0, utils.rotr)(d ^ a, 16);
    c = (c + d) | 0;
    b = (0, utils.rotr)(b ^ c, 12);
    return { a, b, c, d };
}
function G2s(a, b, c, d, x) {
    a = (a + b + x) | 0;
    d = (0, utils.rotr)(d ^ a, 8);
    c = (c + d) | 0;
    b = (0, utils.rotr)(b ^ c, 7);
    return { a, b, c, d };
}
...
function G1b(a, b, c, d, msg, x) {
    ...
    // v[a] = (v[a] + v[b] + x) | 0;
    let ll = _u64.add3L(Al, Bl, Xl);
    Ah = _u64.add3H(ll, Ah, Bh, Xh);
    Al = ll | 0;
    // v[d] = rotr(v[d] ^ v[a], 32)
    ({ Dh, Dl } = { Dh: Dh ^ Ah, Dl: Dl ^ Al });
    ({ Dh, Dl } = { Dh: _u64.rotr32H(Dh, Dl), Dl: _u64.rotr32L(Dh, Dl) });
    // v[c] = (v[c] + v[d]) | 0;
    ({ h: Ch, l: Cl } = _u64.add(Ch, Cl, Dh, Dl));
    // v[b] = rotr(v[b] ^ v[c], 24)
    ({ Bh, Bl } = { Bh: Bh ^ Ch, Bl: Bl ^ Cl });
    ({ Bh, Bl } = { Bh: _u64.rotrSH(Bh, Bl, 24), Bl: _u64.rotrSL(Bh, Bl, 24) });
...
function G2b(a, b, c, d, msg, x) {
    ...
    // v[d] = rotr(v[d] ^ v[a], 16)
    ({ Dh, Dl } = { Dh: Dh ^ Ah, Dl: Dl ^ Al });
    ({ Dh, Dl } = { Dh: _u64.rotrSH(Dh, Dl, 16), Dl: _u64.rotrSL(Dh, Dl, 16) });
    // v[c] = (v[c] + v[d]) | 0;
    ({ h: Ch, l: Cl } = _u64.add(Ch, Cl, Dh, Dl));
    // v[b] = rotr(v[b] ^ v[c], 63)
    ({ Bh, Bl } = { Bh: Bh ^ Ch, Bl: Bl ^ Cl });
    ({ Bh, Bl } = { Bh: _u64.rotrBH(Bh, Bl, 63), Bl: _u64.rotrBL(Bh, Bl, 63) });
    (BBUF[2 * a] = Al), (BBUF[2 * a + 1] = Ah);
    (BBUF[2 * b] = Bl), (BBUF[2 * b + 1] = Bh);
    (BBUF[2 * c] = Cl), (BBUF[2 * c + 1] = Ch);
    (BBUF[2 * d] = Dl), (BBUF[2 * d + 1] = Dh);
...
class BLAKE2 extends utils.Hash {
    constructor(blockLen, outputLen) {
        ...
        this.length = 0;
        this.pos = 0;
        (0, utils.anumber)(blockLen);
        (0, utils.anumber)(outputLen);
        this.blockLen = blockLen;
        this.outputLen = outputLen;
        this.buffer = new Uint8Array(blockLen);
        this.buffer32 = (0, utils.u32)(this.buffer);
    }
    update(data) {
        (0, utils.aexists)(this);
        data = (0, utils.toBytes)(data);
    ...
    digestInto(out) {
        ...
        this.get().forEach((v, i) => (out32[i] = (0, utils.swap8IfBE)(v)));
    }
    digest() {
        const { buffer, outputLen } = this;
        this.digestInto(buffer);
...
class BLAKE2b extends BLAKE2 {
    constructor(opts = {}) {
        ...
        let keyLength = 0;
        if (key !== undefined) {
            key = (0, utils.toBytes)(key);
            keyLength = key.length;
        }
        this.v0l ^= this.outputLen | (keyLength << 8) | (0x01 << 16) | (0x01 << 24);
        if (salt !== undefined) {
            salt = (0, utils.toBytes)(salt);
            const slt = (0, utils.u32)(salt);
            this.v4l ^= (0, utils.swap8IfBE)(slt[0]);
            this.v4h ^= (0, utils.swap8IfBE)(slt[1]);
            this.v5l ^= (0, utils.swap8IfBE)(slt[2]);
            this.v5h ^= (0, utils.swap8IfBE)(slt[3]);
        }
        if (personalization !== undefined) {
            personalization = (0, utils.toBytes)(personalization);
            const pers = (0, utils.u32)(personalization);
            this.v6l ^= (0, utils.swap8IfBE)(pers[0]);
            this.v6h ^= (0, utils.swap8IfBE)(pers[1]);
            this.v7l ^= (0, utils.swap8IfBE)(pers[2]);
            this.v7h ^= (0, utils.swap8IfBE)(pers[3]);
        }
        if (key !== undefined) {
    ...
    compress(msg, offset, isLast) {
        ...
        let { h, l } = _u64.fromBig(BigInt(this.length));
 ...
 */
exports.blake2b = (0, utils.createOptHasher)((opts) => new BLAKE2b(opts));
// prettier-ignore
function compress(s, offset, msg, rounds, v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15) {
    let j = 0;
    for (let i = 0; i < rounds; i++) {
        ({ a: v0, b: v4, c: v8, d: v12 } = (0, _blake.G1s)(v0, v4, v8, v12, msg[offset + s[j++]]));
        ({ a: v0, b: v4, c: v8, d: v12 } = (0, _blake.G2s)(v0, v4, v8, v12, msg[offset + s[j++]]));
        ({ a: v1, b: v5, c: v9, d: v13 } = (0, _blake.G1s)(v1, v5, v9, v13, msg[offset + s[j++]]));
        ({ a: v1, b: v5, c: v9, d: v13 } = (0, _blake.G2s)(v1, v5, v9, v13, msg[offset + s[j++]]));
        ({ a: v2, b: v6, c: v10, d: v14 } = (0, _blake.G1s)(v2, v6, v10, v14, msg[offset + s[j++]]));
        ({ a: v2, b: v6, c: v10, d: v14 } = (0, _blake.G2s)(v2, v6, v10, v14, msg[offset + s[j++]]));
        ({ a: v3, b: v7, c: v11, d: v15 } = (0, _blake.G1s)(v3, v7, v11, v15, msg[offset + s[j++]]));
        ({ a: v3, b: v7, c: v11, d: v15 } = (0, _blake.G2s)(v3, v7, v11, v15, msg[offset + s[j++]]));
        ({ a: v0, b: v5, c: v10, d: v15 } = (0, _blake.G1s)(v0, v5, v10, v15, msg[offset + s[j++]]));
        ({ a: v0, b: v5, c: v10, d: v15 } = (0, _blake.G2s)(v0, v5, v10, v15, msg[offset + s[j++]]));
        ({ a: v1, b: v6, c: v11, d: v12 } = (0, _blake.G1s)(v1, v6, v11, v12, msg[offset + s[j++]]));
        ({ a: v1, b: v6, c: v11, d: v12 } = (0, _blake.G2s)(v1, v6, v11, v12, msg[offset + s[j++]]));
        ({ a: v2, b: v7, c: v8, d: v13 } = (0, _blake.G1s)(v2, v7, v8, v13, msg[offset + s[j++]]));
        ({ a: v2, b: v7, c: v8, d: v13 } = (0, _blake.G2s)(v2, v7, v8, v13, msg[offset + s[j++]]));
        ({ a: v3, b: v4, c: v9, d: v14 } = (0, _blake.G1s)(v3, v4, v9, v14, msg[offset + s[j++]]));
        ({ a: v3, b: v4, c: v9, d: v14 } = (0, _blake.G2s)(v3, v4, v9, v14, msg[offset + s[j++]]));
    }
    return { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 };
}
const B2S_IV = _md.SHA256_IV;
class BLAKE2s extends BLAKE2 {
    constructor(opts = {}) {
        ...
        if (salt !== undefined) {
            salt = (0, utils.toBytes)(salt);
            const slt = (0, utils.u32)(salt);
            this.v4 ^= (0, utils.swap8IfBE)(slt[0]);
            this.v5 ^= (0, utils.swap8IfBE)(slt[1]);
        }
        if (personalization !== undefined) {
            personalization = (0, utils.toBytes)(personalization);
            const pers = (0, utils.u32)(personalization);
            this.v6 ^= (0, utils.swap8IfBE)(pers[0]);
            this.v7 ^= (0, utils.swap8IfBE)(pers[1]);
        }
        if (key !== undefined) {
            // Pad to blockLen and update
            (0, utils.abytes)(key);
    ...
    compress(msg, offset, isLast) {
        const { h, l } = _u64.fromBig(BigInt(this.length));
        // prettier-ignore
        const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = compress(_blake.BSIGMA, offset, msg, 10, this.v0, this.v1, this.v2, this.v3, this.v4, this.v5, this.v6, this.v7, B2S_IV[0], B2S_IV[1], B2S_IV[2], B2S_IV[3], l ^ B2S_IV[4], h ^ B2S_IV[5], isLast ? ~B2S_IV[6] : B2S_IV[6], B2S_IV[7]);
        this.v0 ^= v0 ^ v8;
        this.v1 ^= v1 ^ v9;
        this.v2 ^= v2 ^ v10;
        this.v3 ^= v3 ^ v11;
 ...
 * @param opts - dkLen output length, key for MAC mode, salt, personalization
 */
exports.blake2s = (0, utils.createOptHasher)((opts) => new BLAKE2s(opts));
...
exports.BLAKE2b = blake2.BLAKE2b;
/** @deprecated Use import from `noble/hashes/blake2` module */
exports.blake2b = blake2.blake2b;

});

var dynamicFields = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function deriveDynamicFieldID(parentId, typeTag, key) {
  const address = bcs$2.bcs.Address.serialize(parentId).toBytes();
  const tag = bcs$2.bcs.TypeTag.serialize(typeTag).toBytes();
  const keyLength = bcs$2.bcs.u64().serialize(key.length).toBytes();
  const hash = blake2b.blake2b.create({
    dkLen: 32
  });
  ...
  hash.update(key);
  hash.update(tag);
  return `0x${(0, esm.toHex)(hash.digest().slice(0, 32))}`;
}
...
__export(utils_exports, {
  MIST_PER_SUI: () => constants.MIST_PER_SUI,
  MOVE_STDLIB_ADDRESS: () => constants.MOVE_STDLIB_ADDRESS,
  SUI_ADDRESS_LENGTH: () => suiTypes.SUI_ADDRESS_LENGTH,
  SUI_CLOCK_OBJECT_ID: () => constants.SUI_CLOCK_OBJECT_ID,
  SUI_DECIMALS: () => constants.SUI_DECIMALS,
  SUI_FRAMEWORK_ADDRESS: () => constants.SUI_FRAMEWORK_ADDRESS,
  SUI_SYSTEM_ADDRESS: () => constants.SUI_SYSTEM_ADDRESS,
  SUI_SYSTEM_MODULE_NAME: () => constants.SUI_SYSTEM_MODULE_NAME,
  SUI_SYSTEM_STATE_OBJECT_ID: () => constants.SUI_SYSTEM_STATE_OBJECT_ID,
  SUI_TYPE_ARG: () => constants.SUI_TYPE_ARG,
  deriveDynamicFieldID: () => dynamicFields.deriveDynamicFieldID,
  formatAddress: () => format.formatAddress,
  formatDigest: () => format.formatDigest,
  fromB64: () => esm.fromB64,
  fromBase58: () => esm.fromBase58,
  fromBase64: () => esm.fromBase64,
  fromHEX: () => esm.fromHEX,
  fromHex: () => esm.fromHex,
  isValidNamedPackage: () => moveRegistry.isValidNamedPackage,
  isValidNamedType: () => moveRegistry.isValidNamedType,
  isValidSuiAddress: () => suiTypes.isValidSuiAddress,
  isValidSuiNSName: () => suins.isValidSuiNSName,
  isValidSuiObjectId: () => suiTypes.isValidSuiObjectId,
  isValidTransactionDigest: () => suiTypes.isValidTransactionDigest,
  normalizeStructTag: () => suiTypes.normalizeStructTag,
  normalizeSuiAddress: () => suiTypes.normalizeSuiAddress,
  normalizeSuiNSName: () => suins.normalizeSuiNSName,
  normalizeSuiObjectId: () => suiTypes.normalizeSuiObjectId,
  parseStructTag: () => suiTypes.parseStructTag,
  toB64: () => esm.toB64,
  toBase58: () => esm.toBase58,
  toBase64: () => esm.toBase64,
  toHEX: () => esm.toHEX,
  toHex: () => esm.toHex
});
...
var index$1 = /*@__PURE__*/unwrapExports(utils$1);
...
function isTxContext(param) {
  ...
  return !!struct && (0, suiTypes.normalizeSuiAddress)(struct.package) === (0, suiTypes.normalizeSuiAddress)("0x2") && struct.module === "tx_context" && struct.type === "TxContext";
}
function getPureBcsSchema(typeSignature) {
  if (typeof typeSignature === "string") {
    switch (typeSignature) {
      case "address":
        return bcs$2.bcs.Address;
      case "bool":
        return bcs$2.bcs.Bool;
      case "u8":
        return bcs$2.bcs.U8;
      case "u16":
        return bcs$2.bcs.U16;
      case "u32":
        return bcs$2.bcs.U32;
      case "u64":
        return bcs$2.bcs.U64;
      case "u128":
        return bcs$2.bcs.U128;
      case "u256":
        return bcs$2.bcs.U256;
      default:
  ...
  if ("vector" in typeSignature) {
    if (typeSignature.vector === "u8") {
      return bcs$2.bcs.vector(bcs$2.bcs.U8).transform({
        input: (val) => typeof val === "string" ? new TextEncoder().encode(val) : val,
        output: (val) => val
      });
    }
    const type = getPureBcsSchema(typeSignature.vector);
    return type ? bcs$2.bcs.vector(type) : null;
  }
  if ("datatype" in typeSignature) {
    const pkg = (0, suiTypes.normalizeSuiAddress)(typeSignature.datatype.package);
    if (pkg === (0, suiTypes.normalizeSuiAddress)(utils$1.MOVE_STDLIB_ADDRESS)) {
      if (typeSignature.datatype.module === STD_ASCII_MODULE_NAME && typeSignature.datatype.type === STD_ASCII_STRUCT_NAME) {
        return bcs$2.bcs.String;
      }
    ...
    if (pkg === (0, suiTypes.normalizeSuiAddress)(utils$1.SUI_FRAMEWORK_ADDRESS) && typeSignature.datatype.module === OBJECT_MODULE_NAME && typeSignature.datatype.type === ID_STRUCT_NAME) {
      return bcs$2.bcs.Address;
    }
  }
  return null;
...
function pureBcsSchemaFromOpenMoveTypeSignatureBody(typeSignature) {
  ...
  if ("vector" in typeSignature) {
    return bcs$2.bcs.vector(pureBcsSchemaFromOpenMoveTypeSignatureBody(typeSignature.vector));
  }
...
var Inputs_1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function Pure(data) {
  return {
    $kind: "Pure",
    Pure: {
      bytes: data instanceof Uint8Array ? (0, esm.toBase64)(data) : data.toBase64()
    }
  };
}
const Inputs = {
    ...
    return {
      ...
      Object: {
        ...
        ImmOrOwnedObject: {
          digest,
          version,
          objectId: (0, suiTypes.normalizeSuiAddress)(objectId)
        }
      }
    };
  },
...
var internal = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function safeEnum(options) {
  const unionOptions = Object.entries(options).map(([key, value]) => (0, dist.object)({ [key]: value }));
  return (0, dist.pipe)(
    (0, dist.union)(unionOptions),
    (0, dist.transform)((value) => ({
      ...value,
      $kind: Object.keys(value)[0]
    }))
  );
}
const SuiAddress = (0, dist.pipe)(
  (0, dist.string)(),
  (0, dist.transform)((value) => (0, suiTypes.normalizeSuiAddress)(value)),
  (0, dist.check)(suiTypes.isValidSuiAddress)
);
const ObjectID = SuiAddress;
const BCSBytes = (0, dist.string)();
const JsonU64 = (0, dist.pipe)(
  (0, dist.union)([(0, dist.string)(), (0, dist.pipe)((0, dist.number)(), (0, dist.integer)())]),
  (0, dist.check)((val) => {
    try {
      BigInt(val);
...
const ObjectRef = (0, dist.object)({
  objectId: SuiAddress,
  version: JsonU64,
  digest: (0, dist.string)()
});
const Argument = (0, dist.pipe)(
  (0, dist.union)([
    (0, dist.object)({ GasCoin: (0, dist.literal)(true) }),
    (0, dist.object)({ Input: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()), type: (0, dist.optional)((0, dist.literal)("pure")) }),
    (0, dist.object)({ Input: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()), type: (0, dist.optional)((0, dist.literal)("object")) }),
    (0, dist.object)({ Result: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()) }),
    (0, dist.object)({ NestedResult: (0, dist.tuple)([(0, dist.pipe)((0, dist.number)(), (0, dist.integer)()), (0, dist.pipe)((0, dist.number)(), (0, dist.integer)())]) })
  ]),
  (0, dist.transform)((value) => ({
    ...value,
    $kind: Object.keys(value)[0]
...
const GasData = (0, dist.object)({
  budget: (0, dist.nullable)(JsonU64),
  price: (0, dist.nullable)(JsonU64),
  owner: (0, dist.nullable)(SuiAddress),
  payment: (0, dist.nullable)((0, dist.array)(ObjectRef))
});
const StructTag = (0, dist.object)({
  address: (0, dist.string)(),
  module: (0, dist.string)(),
  name: (0, dist.string)(),
  // type_params in rust, should be updated to use camelCase
  typeParams: (0, dist.array)((0, dist.string)())
});
const OpenMoveTypeSignatureBody = (0, dist.union)([
  (0, dist.literal)("address"),
  (0, dist.literal)("bool"),
  (0, dist.literal)("u8"),
  (0, dist.literal)("u16"),
  (0, dist.literal)("u32"),
  ...
  (0, dist.literal)("u128"),
  (0, dist.literal)("u256"),
  (0, dist.object)({ vector: (0, dist.lazy)(() => OpenMoveTypeSignatureBody) }),
  (0, dist.object)({
    datatype: (0, dist.object)({
      package: (0, dist.string)(),
      module: (0, dist.string)(),
      type: (0, dist.string)(),
      typeParameters: (0, dist.array)((0, dist.lazy)(() => OpenMoveTypeSignatureBody))
    })
  }),
  (0, dist.object)({ typeParameter: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()) })
]);
const OpenMoveTypeSignature = (0, dist.object)({
  ref: (0, dist.nullable)((0, dist.union)([(0, dist.literal)("&"), (0, dist.literal)("&mut")])),
  body: OpenMoveTypeSignatureBody
});
const ProgrammableMoveCall = (0, dist.object)({
  package: ObjectID,
  module: (0, dist.string)(),
  function: (0, dist.string)(),
  // snake case in rust
  typeArguments: (0, dist.array)((0, dist.string)()),
  arguments: (0, dist.array)(Argument),
  _argumentTypes: (0, dist.optional)((0, dist.nullable)((0, dist.array)(OpenMoveTypeSignature)))
});
const $Intent = (0, dist.object)({
  name: (0, dist.string)(),
  inputs: (0, dist.record)((0, dist.string)(), (0, dist.union)([Argument, (0, dist.array)(Argument)])),
  data: (0, dist.record)((0, dist.string)(), (0, dist.unknown)())
});
const Command = safeEnum({
  MoveCall: ProgrammableMoveCall,
  TransferObjects: (0, dist.object)({
    objects: (0, dist.array)(Argument),
    address: Argument
  }),
  SplitCoins: (0, dist.object)({
    coin: Argument,
    amounts: (0, dist.array)(Argument)
  }),
  MergeCoins: (0, dist.object)({
    destination: Argument,
    sources: (0, dist.array)(Argument)
  }),
  Publish: (0, dist.object)({
    modules: (0, dist.array)(BCSBytes),
    dependencies: (0, dist.array)(ObjectID)
  }),
  MakeMoveVec: (0, dist.object)({
    type: (0, dist.nullable)((0, dist.string)()),
    elements: (0, dist.array)(Argument)
  }),
  Upgrade: (0, dist.object)({
    modules: (0, dist.array)(BCSBytes),
    dependencies: (0, dist.array)(ObjectID),
    package: ObjectID,
    ticket: Argument
...
const ObjectArg = safeEnum({
  ...
  SharedObject: (0, dist.object)({
    objectId: ObjectID,
    // snake case in rust
    initialSharedVersion: JsonU64,
    mutable: (0, dist.boolean)()
  }),
  Receiving: ObjectRef
});
const CallArg = safeEnum({
  ...
  UnresolvedPure: (0, dist.object)({
    value: (0, dist.unknown)()
  }),
  UnresolvedObject: (0, dist.object)({
    objectId: ObjectID,
    version: (0, dist.optional)((0, dist.nullable)(JsonU64)),
    digest: (0, dist.optional)((0, dist.nullable)((0, dist.string)())),
    initialSharedVersion: (0, dist.optional)((0, dist.nullable)(JsonU64))
  })
});
...
const TransactionExpiration = safeEnum({
  None: (0, dist.literal)(true),
  Epoch: JsonU64
});
const TransactionData = (0, dist.object)({
  version: (0, dist.literal)(2),
  sender: (0, dist.nullish)(SuiAddress),
  expiration: (0, dist.nullish)(TransactionExpiration),
  gasData: GasData,
  inputs: (0, dist.array)(CallArg),
  commands: (0, dist.array)(Command)
});

});

var Commands_1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const Commands = {
  ...
  TransferObjects(objects, address) {
    return {
      ...
      TransferObjects: {
        objects: objects.map((o) => (0, dist.parse)(internal.Argument, o)),
        address: (0, dist.parse)(internal.Argument, address)
      }
    };
  },
  SplitCoins(coin, amounts) {
    return {
      $kind: "SplitCoins",
      SplitCoins: {
        coin: (0, dist.parse)(internal.Argument, coin),
        amounts: amounts.map((o) => (0, dist.parse)(internal.Argument, o))
      }
    };
  },
  MergeCoins(destination, sources) {
    return {
      $kind: "MergeCoins",
      MergeCoins: {
        destination: (0, dist.parse)(internal.Argument, destination),
        sources: sources.map((o) => (0, dist.parse)(internal.Argument, o))
      }
    };
  },
  Publish({
    ...
    return {
      ...
      Publish: {
        modules: modules.map(
          (module2) => typeof module2 === "string" ? module2 : (0, esm.toBase64)(new Uint8Array(module2))
        ),
        dependencies: dependencies.map((dep) => (0, suiTypes.normalizeSuiObjectId)(dep))
      }
    };
  },
  Upgrade({
    ...
    return {
      ...
      Upgrade: {
        ...
        dependencies: dependencies.map((dep) => (0, suiTypes.normalizeSuiObjectId)(dep)),
        package: packageId,
        ticket: (0, dist.parse)(internal.Argument, ticket)
      }
    };
  },
  MakeMoveVec({
    ...
    return {
      ...
      MakeMoveVec: {
        type: type ?? null,
        elements: elements.map((o) => (0, dist.parse)(internal.Argument, o))
      }
    };
  },
  Intent({
      ...
      $Intent: {
        ...
        inputs: Object.fromEntries(
          Object.entries(inputs).map(([key, value]) => [
            key,
            Array.isArray(value) ? value.map((o) => (0, dist.parse)(internal.Argument, o)) : (0, dist.parse)(internal.Argument, value)
          ])
        ),
        data
      }
...
var v1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const ObjectRef = (0, dist.object)({
  digest: (0, dist.string)(),
  objectId: (0, dist.string)(),
  version: (0, dist.union)([(0, dist.pipe)((0, dist.number)(), (0, dist.integer)()), (0, dist.string)(), (0, dist.bigint)()])
});
const ObjectArg = (0, internal.safeEnum)({
  ImmOrOwned: ObjectRef,
  Shared: (0, dist.object)({
    objectId: internal.ObjectID,
    initialSharedVersion: internal.JsonU64,
    mutable: (0, dist.boolean)()
  }),
  Receiving: ObjectRef
});
const NormalizedCallArg = (0, internal.safeEnum)({
  Object: ObjectArg,
  Pure: (0, dist.array)((0, dist.pipe)((0, dist.number)(), (0, dist.integer)()))
});
const TransactionInput = (0, dist.union)([
  (0, dist.object)({
    kind: (0, dist.literal)("Input"),
    index: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()),
    value: (0, dist.unknown)(),
    type: (0, dist.optional)((0, dist.literal)("object"))
  }),
  (0, dist.object)({
    kind: (0, dist.literal)("Input"),
    index: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()),
    value: (0, dist.unknown)(),
    type: (0, dist.literal)("pure")
  })
]);
const TransactionExpiration = (0, dist.union)([
  (0, dist.object)({ Epoch: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()) }),
  (0, dist.object)({ None: (0, dist.nullable)((0, dist.literal)(true)) })
]);
const StringEncodedBigint = (0, dist.pipe)(
  (0, dist.union)([(0, dist.number)(), (0, dist.string)(), (0, dist.bigint)()]),
  (0, dist.check)((val) => {
...
const TypeTag = (0, dist.union)([
  (0, dist.object)({ bool: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ u8: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ u64: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ u128: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ address: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ signer: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ vector: (0, dist.lazy)(() => TypeTag) }),
  (0, dist.object)({ struct: (0, dist.lazy)(() => StructTag) }),
  (0, dist.object)({ u16: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ u32: (0, dist.nullable)((0, dist.literal)(true)) }),
  (0, dist.object)({ u256: (0, dist.nullable)((0, dist.literal)(true)) })
]);
const StructTag = (0, dist.object)({
  address: (0, dist.string)(),
  module: (0, dist.string)(),
  name: (0, dist.string)(),
  typeParams: (0, dist.array)(TypeTag)
});
const GasConfig = (0, dist.object)({
  budget: (0, dist.optional)(StringEncodedBigint),
  price: (0, dist.optional)(StringEncodedBigint),
  payment: (0, dist.optional)((0, dist.array)(ObjectRef)),
  owner: (0, dist.optional)((0, dist.string)())
});
const TransactionArgumentTypes = [
  TransactionInput,
  (0, dist.object)({ kind: (0, dist.literal)("GasCoin") }),
  (0, dist.object)({ kind: (0, dist.literal)("Result"), index: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()) }),
  (0, dist.object)({
    kind: (0, dist.literal)("NestedResult"),
    index: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()),
    resultIndex: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)())
  })
];
const TransactionArgument = (0, dist.union)([...TransactionArgumentTypes]);
const MoveCallTransaction = (0, dist.object)({
  kind: (0, dist.literal)("MoveCall"),
  target: (0, dist.pipe)(
    (0, dist.string)(),
    (0, dist.check)((target) => target.split("::").length === 3)
  ),
  typeArguments: (0, dist.array)((0, dist.string)()),
  arguments: (0, dist.array)(TransactionArgument)
});
const TransferObjectsTransaction = (0, dist.object)({
  kind: (0, dist.literal)("TransferObjects"),
  objects: (0, dist.array)(TransactionArgument),
  address: TransactionArgument
});
const SplitCoinsTransaction = (0, dist.object)({
  kind: (0, dist.literal)("SplitCoins"),
  coin: TransactionArgument,
  amounts: (0, dist.array)(TransactionArgument)
});
const MergeCoinsTransaction = (0, dist.object)({
  kind: (0, dist.literal)("MergeCoins"),
  destination: TransactionArgument,
  sources: (0, dist.array)(TransactionArgument)
});
const MakeMoveVecTransaction = (0, dist.object)({
  kind: (0, dist.literal)("MakeMoveVec"),
  type: (0, dist.union)([(0, dist.object)({ Some: TypeTag }), (0, dist.object)({ None: (0, dist.nullable)((0, dist.literal)(true)) })]),
  objects: (0, dist.array)(TransactionArgument)
});
const PublishTransaction = (0, dist.object)({
  kind: (0, dist.literal)("Publish"),
  modules: (0, dist.array)((0, dist.array)((0, dist.pipe)((0, dist.number)(), (0, dist.integer)()))),
  dependencies: (0, dist.array)((0, dist.string)())
});
const UpgradeTransaction = (0, dist.object)({
  kind: (0, dist.literal)("Upgrade"),
  modules: (0, dist.array)((0, dist.array)((0, dist.pipe)((0, dist.number)(), (0, dist.integer)()))),
  dependencies: (0, dist.array)((0, dist.string)()),
  packageId: (0, dist.string)(),
...
const TransactionType = (0, dist.union)([...TransactionTypes]);
const SerializedTransactionDataV1 = (0, dist.object)({
  version: (0, dist.literal)(1),
  sender: (0, dist.optional)((0, dist.string)()),
  expiration: (0, dist.nullish)(TransactionExpiration),
  gasConfig: GasConfig,
  inputs: (0, dist.array)(TransactionInput),
  transactions: (0, dist.array)(TransactionType)
});
    ...
    (input, index) => {
      ...
      if (input.Pure) {
        return {
          ...
          index,
          value: {
            Pure: Array.from((0, esm.fromBase64)(input.Pure.bytes))
          },
          type: "pure"
        };
      }
  ...
  return {
    ...
    transactions: transactionData.commands.map((command) => {
      if (command.MakeMoveVec) {
        return {
          kind: "MakeMoveVec",
          type: command.MakeMoveVec.type === null ? { None: true } : { Some: bcs$2.TypeTagSerializer.parseFromStr(command.MakeMoveVec.type) },
      ...
      if (command.Publish) {
        return {
          kind: "Publish",
          modules: command.Publish.modules.map((mod) => Array.from((0, esm.fromBase64)(mod))),
      ...
      if (command.Upgrade) {
        return {
          kind: "Upgrade",
          modules: command.Upgrade.modules.map((mod) => Array.from((0, esm.fromBase64)(mod))),
...
function transactionDataFromV1(data) {
  return (0, dist.parse)(internal.TransactionData, {
    version: 2,
    ...
    inputs: data.inputs.map((input) => {
      if (input.kind === "Input") {
        if ((0, dist.is)(NormalizedCallArg, input.value)) {
          const value = (0, dist.parse)(NormalizedCallArg, input.value);
          if (value.Object) {
          ...
          return {
            Pure: {
              bytes: (0, esm.toBase64)(new Uint8Array(value.Pure))
            }
          };
        }
    ...
    commands: data.transactions.map((transaction) => {
      switch (transaction.kind) {
        case "MakeMoveVec":
          return {
            MakeMoveVec: {
              type: "Some" in transaction.type ? bcs$2.TypeTagSerializer.tagToString(transaction.type.Some) : null,
        ...
        case "Publish": {
          return {
            Publish: {
              modules: transaction.modules.map((mod) => (0, esm.toBase64)(Uint8Array.from(mod))),
...
function enumUnion(options) {
  return (0, dist.union)(
    Object.entries(options).map(([key, value]) => (0, dist.object)({ [key]: value }))
  );
}
const Argument = enumUnion({
  GasCoin: (0, dist.literal)(true),
  Input: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()),
  Result: (0, dist.pipe)((0, dist.number)(), (0, dist.integer)()),
  NestedResult: (0, dist.tuple)([(0, dist.pipe)((0, dist.number)(), (0, dist.integer)()), (0, dist.pipe)((0, dist.number)(), (0, dist.integer)())])
});
const GasData = (0, dist.object)({
  budget: (0, dist.nullable)(internal.JsonU64),
  price: (0, dist.nullable)(internal.JsonU64),
  owner: (0, dist.nullable)(internal.SuiAddress),
  payment: (0, dist.nullable)((0, dist.array)(internal.ObjectRef))
});
const ProgrammableMoveCall = (0, dist.object)({
  package: internal.ObjectID,
  module: (0, dist.string)(),
  function: (0, dist.string)(),
  // snake case in rust
  typeArguments: (0, dist.array)((0, dist.string)()),
...
const Command = enumUnion({
  ...
  Publish: (0, dist.object)({
    modules: (0, dist.array)(internal.BCSBytes),
    dependencies: (0, dist.array)(internal.ObjectID)
  }),
  MakeMoveVec: (0, dist.object)({
    type: (0, dist.nullable)((0, dist.string)()),
    elements: (0, dist.array)(Argument)
...
const ObjectArg = enumUnion({
  ImmOrOwnedObject: internal.ObjectRef,
  SharedObject: (0, dist.object)({
    objectId: internal.ObjectID,
    // snake case in rust
    initialSharedVersion: internal.JsonU64,
  ...
  Receiving: internal.ObjectRef
});
const CallArg = enumUnion({
  Object: ObjectArg,
  Pure: (0, dist.object)({
    bytes: internal.BCSBytes
  }),
  UnresolvedPure: (0, dist.object)({
    value: (0, dist.unknown)()
  }),
  UnresolvedObject: (0, dist.object)({
    objectId: internal.ObjectID,
    version: (0, dist.optional)((0, dist.nullable)(internal.JsonU64)),
    digest: (0, dist.optional)((0, dist.nullable)((0, dist.string)())),
    initialSharedVersion: (0, dist.optional)((0, dist.nullable)(internal.JsonU64))
  })
});
const TransactionExpiration = enumUnion({
  None: (0, dist.literal)(true),
  Epoch: internal.JsonU64
});
const SerializedTransactionDataV2 = (0, dist.object)({
  version: (0, dist.literal)(2),
  sender: (0, dist.nullish)(internal.SuiAddress),
  expiration: (0, dist.nullish)(TransactionExpiration),
  gasData: GasData,
  inputs: (0, dist.array)(CallArg),
  commands: (0, dist.array)(Command)
...
const toBase58$1 = (buffer) => base58.encode(buffer);
const fromBase58$1 = (str) => base58.decode(str);

function fromBase64$1(base64String) {
  return Uint8Array.from(atob(base64String), (char) => char.charCodeAt(0));
}
...
function toBase64$1(bytes) {
  ...
  let output = "";
  for (var i = 0; i < bytes.length; i += CHUNK_SIZE$1) {
    const chunk = bytes.slice(i, i + CHUNK_SIZE$1);
    output += String.fromCharCode(...chunk);
  }
  return btoa(output);
}
...
var jsonRpcResolver = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
async function setGasPayment(transactionData, options) {
  if (!transactionData.gasConfig.payment) {
    ...
    transactionData.gasConfig.payment = paymentCoins.map((payment) => (0, dist.parse)(internal.ObjectRef, payment));
  }
}
async function resolveObjectReferences(transactionData, options) {
  ...
  const dedupedIds = [
    ...new Set(
      objectsToResolve.map((input) => (0, utils$1.normalizeSuiObjectId)(input.UnresolvedObject.objectId))
    )
  ];
  const objectChunks = dedupedIds.length ? (0, esm$1.chunk)(dedupedIds, MAX_OBJECTS_PER_FETCH) : [];
  ...
  for (const [index, input] of transactionData.inputs.entries()) {
    ...
    let updated;
    const id = (0, utils$1.normalizeSuiAddress)(input.UnresolvedObject.objectId);
    const object = objectsById.get(id);
    if (input.UnresolvedObject.initialSharedVersion ?? object?.initialSharedVersion) {
      updated = Inputs_1.Inputs.SharedObjectRef({
        objectId: id,
        initialSharedVersion: input.UnresolvedObject.initialSharedVersion || object?.initialSharedVersion,
        mutable: isUsedAsMutable(transactionData, index)
      });
    } else if (isUsedAsReceiving(transactionData, index)) {
      updated = Inputs_1.Inputs.ReceivingRef(
        {
          objectId: id,
    ...
    transactionData.inputs[transactionData.inputs.indexOf(input)] = updated ?? Inputs_1.Inputs.ObjectRef({
      objectId: id,
      digest: input.UnresolvedObject.digest ?? object?.digest,
      version: input.UnresolvedObject.version ?? object?.version
    });
...
async function normalizeInputs(transactionData, options) {
    ...
    switch (command.$kind) {
      case "SplitCoins":
        command.SplitCoins.amounts.forEach((amount) => {
          normalizeRawArgument(amount, bcs$2.bcs.U64, transactionData);
        });
        break;
      case "TransferObjects":
        normalizeRawArgument(command.TransferObjects.address, bcs$2.bcs.Address, transactionData);
        break;
    }
  });
    ...
    await Promise.all(
      [...moveFunctionsToResolve].map(async (functionName) => {
        ...
        moveFunctionParameters.set(
          functionName,
          def.parameters.map((param) => (0, serializer.normalizedTypeToMoveTypeSignature)(param))
        );
      })
    );
  }
  if (moveCallsToResolve.length) {
    await Promise.all(
      moveCallsToResolve.map(async (moveCall) => {
        ...
        const hasTxContext = parameters.length > 0 && (0, serializer.isTxContext)(parameters.at(-1));
  ...
  commands.forEach((command) => {
    ...
    params.forEach((param, i) => {
      ...
      const schema = (0, serializer.getPureBcsSchema)(param.body);
      if (schema) {
        arg.type = "pure";
        inputs[inputs.indexOf(input)] = Inputs_1.Inputs.Pure(schema.serialize(inputValue));
        return;
      }
...
function normalizeRawArgument(arg, schema, transactionData) {
  ...
  transactionData.inputs[arg.Input] = Inputs_1.Inputs.Pure(schema.serialize(input.UnresolvedPure.value));
}
...
var object$1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
var pure$1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function createPure(makePure) {
  function pure$1(typeOrSerializedValue, value) {
    if (typeof typeOrSerializedValue === "string") {
      return makePure((0, pure.pureBcsSchemaFromTypeName)(typeOrSerializedValue).serialize(value));
    }
    if (typeOrSerializedValue instanceof Uint8Array || (0, esm.isSerializedBcs)(typeOrSerializedValue)) {
      return makePure(typeOrSerializedValue);
    }
    throw new Error("tx.pure must be called either a bcs type name, or a serialized bcs value");
  }
  pure$1.u8 = (value) => makePure(bcs$2.bcs.U8.serialize(value));
  pure$1.u16 = (value) => makePure(bcs$2.bcs.U16.serialize(value));
  pure$1.u32 = (value) => makePure(bcs$2.bcs.U32.serialize(value));
  pure$1.u64 = (value) => makePure(bcs$2.bcs.U64.serialize(value));
  pure$1.u128 = (value) => makePure(bcs$2.bcs.U128.serialize(value));
  pure$1.u256 = (value) => makePure(bcs$2.bcs.U256.serialize(value));
  pure$1.bool = (value) => makePure(bcs$2.bcs.Bool.serialize(value));
  pure$1.string = (value) => makePure(bcs$2.bcs.String.serialize(value));
  pure$1.address = (value) => makePure(bcs$2.bcs.Address.serialize(value));
  pure$1.id = pure$1.address;
  pure$1.vector = (type, value) => {
    return makePure(
      bcs$2.bcs.vector((0, pure.pureBcsSchemaFromTypeName)(type)).serialize(value)
    );
  };
  pure$1.option = (type, value) => {
    return makePure(bcs$2.bcs.option((0, pure.pureBcsSchemaFromTypeName)(type)).serialize(value));
  };
  return pure$1;
}
...
var hash$1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function hashTypedData(typeTag, data) {
  ...
  return (0, blake2b.blake2b)(dataWithTag, { dkLen: 32 });
}

});

var TransactionData = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
function prepareSuiAddress(address) {
  return (0, suiTypes.normalizeSuiAddress)(address).replace("0x", "");
}
class TransactionDataBuilder {
  ...
  static fromKindBytes(bytes) {
    const kind = bcs$2.bcs.TransactionKind.parse(bytes);
  ...
  static fromBytes(bytes) {
    const rawData = bcs$2.bcs.TransactionData.parse(bytes);
  ...
  static restore(data) {
    if (data.version === 2) {
      return new TransactionDataBuilder((0, dist.parse)(internal.TransactionData, data));
    } else {
      return new TransactionDataBuilder((0, dist.parse)(internal.TransactionData, (0, v1.transactionDataFromV1)(data)));
    }
  }
  /**
  ...
  static getDigestFromBytes(bytes) {
    const hash = (0, hash$1.hashTypedData)("TransactionData", bytes);
    return (0, esm.toBase58)(hash);
  }
  ...
  build({
    ...
    if (onlyTransactionKind) {
      return bcs$2.bcs.TransactionKind.serialize(kind, { maxSize: maxSizeBytes }).toBytes();
    }
    ...
    return bcs$2.bcs.TransactionData.serialize(
      { V1: transactionData },
  ...
  snapshot() {
    return (0, dist.parse)(internal.TransactionData, this);
  }
}
...
function getIdFromCallArg(arg) {
  if (typeof arg === "string") {
    return (0, suiTypes.normalizeSuiAddress)(arg);
  }
  if (arg.Object) {
    if (arg.Object.ImmOrOwnedObject) {
      return (0, suiTypes.normalizeSuiAddress)(arg.Object.ImmOrOwnedObject.objectId);
    }
    if (arg.Object.Receiving) {
      return (0, suiTypes.normalizeSuiAddress)(arg.Object.Receiving.objectId);
    }
    return (0, suiTypes.normalizeSuiAddress)(arg.Object.SharedObject.objectId);
  }
  if (arg.UnresolvedObject) {
    return (0, suiTypes.normalizeSuiAddress)(arg.UnresolvedObject.objectId);
  }
  return void 0;
}
function isArgument(value) {
  return (0, dist.is)(internal.Argument, value);
}

});

var Transaction_1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const _Transaction = class _Transaction {
  constructor() {
     ...
     */
    this.object = (0, object$1.createObjectMethods)(
      (value) => {
        if (typeof value === "function") {
          return this.object(value(this));
        }
        if (typeof value === "object" && (0, dist.is)(internal.Argument, value)) {
          return value;
        }
        const id = (0, utils$2.getIdFromCallArg)(value);
        const inserted = __privateGet(this, _data).inputs.find((i) => id === (0, utils$2.getIdFromCallArg)(i));
        ...
        return inserted ? { $kind: "Input", Input: __privateGet(this, _data).inputs.indexOf(inserted), type: "object" } : __privateGet(this, _data).addInput(
          ...
          typeof value === "string" ? {
            $kind: "UnresolvedObject",
            UnresolvedObject: { objectId: (0, suiTypes.normalizeSuiAddress)(value) }
          } : value
        );
      }
    );
    const globalPlugins = getGlobalPluginRegistry();
    __privateSet(this, _data, new TransactionData.TransactionDataBuilder());
  ...
  static fromKind(serialized) {
    ...
    __privateSet(tx, _data, TransactionData.TransactionDataBuilder.fromKindBytes(
      typeof serialized === "string" ? (0, esm.fromBase64)(serialized) : serialized
    ));
    return tx;
  }
  /**
  ...
  static from(transaction) {
    ...
    if (isTransaction(transaction)) {
      __privateSet(newTransaction, _data, new TransactionData.TransactionDataBuilder(transaction.getData()));
    } else if (typeof transaction !== "string" || !transaction.startsWith("{")) {
      __privateSet(newTransaction, _data, TransactionData.TransactionDataBuilder.fromBytes(
        typeof transaction === "string" ? (0, esm.fromBase64)(transaction) : transaction
      ));
    } else {
      __privateSet(newTransaction, _data, TransactionData.TransactionDataBuilder.restore(JSON.parse(transaction)));
    }
  ...
  setExpiration(expiration) {
    __privateGet(this, _data).expiration = expiration ? (0, dist.parse)(internal.TransactionExpiration, expiration) : null;
  }
  setGasPrice(price) {
  ...
  setGasPayment(payments) {
    __privateGet(this, _data).gasConfig.payment = payments.map((payment) => (0, dist.parse)(internal.ObjectRef, payment));
  }
  /** @deprecated Use `getData()` instead. */
  get blockData() {
    return (0, v1.serializeV1TransactionData)(__privateGet(this, _data).snapshot());
  }
  ...
  get pure() {
    Object.defineProperty(this, "pure", {
      enumerable: false,
      value: (0, pure$1.createPure)((value) => {
        if ((0, esm.isSerializedBcs)(value)) {
        ...
        return __privateGet(this, _data).addInput(
          "pure",
          (0, dist.is)(internal.NormalizedCallArg, value) ? (0, dist.parse)(internal.NormalizedCallArg, value) : value instanceof Uint8Array ? Inputs_1.Inputs.Pure(value) : { $kind: "UnresolvedPure", UnresolvedPure: { value } }
        );
      })
    });
    return this.pure;
   ...
   */
  receivingRef(...args) {
    return this.object(Inputs_1.Inputs.ReceivingRef(...args));
  }
  /**
  ...
  // Method shorthands:
  splitCoins(coin, amounts) {
    const command = Commands_1.Commands.SplitCoins(
  ...
  mergeCoins(destination, sources) {
    return this.add(
      Commands_1.Commands.MergeCoins(
  ...
  transferObjects(objects, address) {
    return this.add(
      Commands_1.Commands.TransferObjects(
  ...
  makeMoveVec({
    ...
    return this.add(
      Commands_1.Commands.MakeMoveVec({
        type,
   ...
   * */
  serialize() {
    return JSON.stringify((0, v1.serializeV1TransactionData)(__privateGet(this, _data).snapshot()));
  }
  async toJSON(options = {}) {
    await this.prepareForSerialization(options);
    return JSON.stringify(
      (0, dist.parse)(v2.SerializedTransactionDataV2, __privateGet(this, _data).snapshot()),
...
resolveArgument_fn = function(arg) {
  if (typeof arg === "function") {
    return (0, dist.parse)(internal.Argument, arg(this));
  }
  return (0, dist.parse)(internal.Argument, arg);
};
prepareBuild_fn = async function(options) {
  if (!options.onlyTransactionKind && !__privateGet(this, _data).sender) {
    throw new Error("Missing transaction sender");
  }
  await __privateMethod(this, _Transaction_instances, runPlugins_fn).call(this, [...__privateGet(this, _buildPlugins), jsonRpcResolver.resolveTransactionData], options);
};
...
var ObjectCache_1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
class AsyncCache {
  ...
  async getMoveFunctionDefinition(ref) {
    const functionName = `${(0, suiTypes.normalizeSuiAddress)(ref.package)}::${ref.module}::${ref.function}`;
    return this.get("MoveFunction", functionName);
  }
  async addMoveFunctionDefinition(functionEntry) {
    const pkg = (0, suiTypes.normalizeSuiAddress)(functionEntry.package);
...
var caching = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
class CachingTransactionExecutor {
  constructor({
    ...
    this.cache = new ObjectCache_1.ObjectCache(options);
  }
  /**
  ...
  async executeTransaction({
    ...
    const bytes = (0, Transaction_1.isTransaction)(transaction) ? await this.buildTransaction({ transaction }) : transaction;
    ...
    if (results.rawEffects) {
      const effects = bcs$2.bcs.TransactionEffects.parse(Uint8Array.from(results.rawEffects));
...
var serial = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
class SerialTransactionExecutor {
  constructor({
    ...
    __privateAdd(this, _queue, new queue.SerialQueue());
    ...
    __privateAdd(this, _buildTransaction, async (transaction) => {
      ...
      const copy = Transaction_1.Transaction.from(transaction);
      if (gasCoin) {
    ...
    __privateSet(this, _cache, new caching.CachingTransactionExecutor({
  ...
  executeTransaction(transaction, options, additionalSignatures = []) {
    return __privateGet(this, _queue).runTask(async () => {
      const bytes = (0, Transaction_1.isTransaction)(transaction) ? await __privateGet(this, _buildTransaction).call(this, transaction) : transaction;
      ...
      return {
        ...
        effects: (0, esm.toBase64)(effectsBytes),
        data: results
      };
    });
  }
...
var parallel = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
class ParallelTransactionExecutor {
  constructor(options) {
    ...
    __privateAdd(this, _buildQueue, new queue.SerialQueue());
    ...
    __privateSet(this, _executeQueue, new queue.ParallelQueue(__privateGet(this, _maxPoolSize)));
  ...
  async executeTransaction(transaction, options, additionalSignatures = []) {
    const { promise, resolve, reject } = (0, esm$1.promiseWithResolvers)();
...
execute_fn = async function(transaction, usedObjects, options, additionalSignatures = []) {
  ...
  try {
    ...
    const effectsBytes = Uint8Array.from(results.rawEffects);
    const effects = bcs$2.bcs.TransactionEffects.parse(effectsBytes);
    const gasResult = (0, serial.getGasCoinFromEffects)(effects);
    ...
    if (gasCoin && gasUsed && gasResult.owner === __privateGet(this, _signer).toSuiAddress()) {
      ...
      new TransactionData.TransactionDataBuilder(transaction.getData()).mapArguments((arg) => {
        if (arg.$kind === "GasCoin") {
          usesGasCoin = true;
        }
        return arg;
...
refillCoinPool_fn = async function() {
  ...
  const txb = new Transaction_1.Transaction();
  ...
  const effects = bcs$2.bcs.TransactionEffects.parse(Uint8Array.from(result.rawEffects));
  ...
  const gasObject = (0, serial.getGasCoinFromEffects)(effects).ref;
...
var CoinWithBalance = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const SUI_TYPE = (0, suiTypes.normalizeStructTag)("0x2::sui::SUI");
function coinWithBalance({
  ...
  return (tx) => {
    ...
    const coinType = type === "gas" ? type : (0, suiTypes.normalizeStructTag)(type);
    coinResult = tx.add(
      Commands_1.Commands.Intent({
...
const CoinWithBalanceData = (0, dist.object)({
  type: (0, dist.string)(),
  balance: (0, dist.bigint)()
});
async function resolveCoinBalance(transactionData, buildOptions, next) {
  ...
  for (const command of transactionData.commands) {
    if (command.$kind === "$Intent" && command.$Intent.name === COIN_WITH_BALANCE) {
      const { type, balance } = (0, dist.parse)(CoinWithBalanceData, command.$Intent.data);
  ...
  const client = (0, jsonRpcResolver.getClient)(buildOptions);
  await Promise.all(
  ...
  for (const [index, transaction] of transactionData.commands.entries()) {
    ...
    if (balance === 0n && type !== "gas") {
      transactionData.replaceCommand(
        index,
        Commands_1.Commands.MoveCall({ target: "0x2::coin::zero", typeArguments: [type] })
      );
      continue;
    }
    const commands = [];
    if (!mergedCoins.has(type)) {
      ...
      if (rest.length > 0) {
        commands.push(Commands_1.Commands.MergeCoins(first, rest));
      }
      mergedCoins.set(type, first);
    }
    commands.push(
      Commands_1.Commands.SplitCoins(mergedCoins.get(type), [
        transactionData.addInput("pure", Inputs_1.Inputs.Pure(bcs$2.bcs.u64().serialize(balance)))
      ])
    );
...
var Arguments_1 = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const Arguments = {
  pure: (0, pure$1.createPure)((value) => (tx) => tx.pure(value)),
  object: (0, object$1.createObjectMethods)((value) => (tx) => tx.object(value)),
...
function findNamesInTransaction(builder) {
  ...
  for (const command of builder.commands) {
    ...
    if (hasMvrName(pkg)) {
      if (!(0, moveRegistry.isValidNamedPackage)(pkg)) throw new Error(`Invalid package name: ${pkg}`);
      packages.add(pkg);
    }
...
function findMvrNames(type) {
  ...
  const tag = isStructTag(type) ? type : (0, suiTypes.parseStructTag)(type);
...
function populateNamedTypesFromCache(types, typeCache) {
  const composedTypes = {};
  types.forEach((type) => {
    const normalized = (0, suiTypes.normalizeStructTag)(findAndReplaceCachedTypes(type, typeCache));
    composedTypes[type] = normalized;
  });
  return composedTypes;
}
function findAndReplaceCachedTypes(tag, typeCache) {
  const type = isStructTag(tag) ? tag : (0, suiTypes.parseStructTag)(tag);
...
function getNamesFromTypeList(types) {
  ...
  for (const type of types) {
    if (hasMvrName(type)) {
      if (!(0, moveRegistry.isValidNamedType)(type)) throw new Error(`Invalid type with names: ${type}`);
      names.add(type);
    }
  }
  return names;
...
var NamedPackagesPlugin = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
const namedPackagesPlugin = ({
  ...
  Object.keys(overrides.types).forEach((type) => {
    if ((0, suiTypes.parseStructTag)(type).typeParams.length > 0)
      throw new Error(
  ...
  return async (transactionData, _buildOptions, next) => {
    const names = (0, utils$3.findNamesInTransaction)(transactionData);
    const [packages, types] = await Promise.all([
      ...
      resolveTypes(
        [...(0, utils$3.getFirstLevelNamedTypes)(names.types)].filter((x) => !cache.types[x]),
        url,
        pageSize
      )
    ]);
    ...
    const composedTypes = (0, utils$3.populateNamedTypesFromCache)(names.types, cache.types);
    (0, utils$3.replaceNames)(transactionData, {
  ...
  async function resolvePackages(packages, apiUrl, pageSize2) {
    ...
    const batches = (0, utils$3.batch)(packages, pageSize2);
    const results = {};
    await Promise.all(
  ...
  async function resolveTypes(types, apiUrl, pageSize2) {
    ...
    const batches = (0, utils$3.batch)(types, pageSize2);
    const results = {};
    await Promise.all(
      batches.map(async (batch2) => {
...
var transactions = createCommonjsModule(function (module) {
var __defProp = Object.defineProperty;
var __getOwnPropDesc = Object.getOwnPropertyDescriptor;
var __getOwnPropNames = Object.getOwnPropertyNames;
var __hasOwnProp = Object.prototype.hasOwnProperty;
...
__export(transactions_exports, {
  Arguments: () => Arguments_1.Arguments,
  AsyncCache: () => ObjectCache_1.AsyncCache,
  Commands: () => Commands_1.Commands,
  Inputs: () => Inputs_1.Inputs,
  ObjectCache: () => ObjectCache_1.ObjectCache,
  ParallelTransactionExecutor: () => parallel.ParallelTransactionExecutor,
  SerialTransactionExecutor: () => serial.SerialTransactionExecutor,
  Transaction: () => Transaction_1.Transaction,
  TransactionDataBuilder: () => TransactionData.TransactionDataBuilder,
  UpgradePolicy: () => Commands_1.UpgradePolicy,
  coinWithBalance: () => CoinWithBalance.coinWithBalance,
  getPureBcsSchema: () => serializer.getPureBcsSchema,
  isArgument: () => utils$2.isArgument,
  isTransaction: () => Transaction_1.isTransaction,
  namedPackagesPlugin: () => NamedPackagesPlugin.namedPackagesPlugin,
  normalizedTypeToMoveTypeSignature: () => serializer.normalizedTypeToMoveTypeSignature
});
...
var index$2 = /*@__PURE__*/unwrapExports(transactions);
...
async function signAndExecuteTransaction(wallet, input) {
  ...
  const transactionBlock = index$2.Transaction.from(await input.transaction.toJSON());
  ...
  ] = index.bcs.SenderSignedData.parse(index$1.fromBase64(rawTransaction));
  const bytes = index.bcs.TransactionData.serialize(bcsTransaction).toBase64();
  return {
    digest,
    signature,
    bytes,
    effects: index$1.toBase64(new Uint8Array(rawEffects))
  };
}
async function signTransaction(wallet, input) {
  ...
  const transaction = index$2.Transaction.from(await input.transaction.toJSON());
...
export { Connect, DEPRECATED_getWallets, DEPRECATED_registerWallet, Disconnect, Events, ReadonlyWalletAccount, SUI_CHAINS, SUI_DEVNET_CHAIN, SUI_LOCALNET_CHAIN, SUI_MAINNET_CHAIN, SUI_TESTNET_CHAIN, StandardConnect, StandardDisconnect, StandardEvents, WALLET_STANDARD_ERROR__FEATURES__WALLET_ACCOUNT_CHAIN_UNSUPPORTED, WALLET_STANDARD_ERROR__FEATURES__WALLET_ACCOUNT_FEATURE_UNIMPLEMENTED, WALLET_STANDARD_ERROR__FEATURES__WALLET_FEATURE_UNIMPLEMENTED, WALLET_STANDARD_ERROR__REGISTRY__WALLET_ACCOUNT_NOT_FOUND, WALLET_STANDARD_ERROR__REGISTRY__WALLET_NOT_FOUND, WALLET_STANDARD_ERROR__USER__REQUEST_REJECTED, WalletStandardError, arraysEqual, bytesEqual, concatBytes, getWallets, guard$1 as guard, isSuiChain, isWalletStandardError, isWalletWithRequiredFeatureSet, pick, registerWallet, safeCaptureStackTrace, signAndExecuteTransaction, signTransaction };
